...
CREATE TABLE `addon_option` (
  ...
  `addon_group` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_by` int unsigned DEFAULT NULL,
  `updated_by` int unsigned DEFAULT NULL,
  PRIMARY KEY (`addon_option_id`),
  UNIQUE KEY `uk_addon_option_code` (`code`),
  KEY `idx_addon_option_active` (`is_active`),
  KEY `idx_addon_group_active_order` (`addon_group`,`is_active`,`display_order`,`addon_option_id`),
  KEY `idx_addon_name` (`name`),
  KEY `fk_addon_option_created_by` (`created_by`),
  KEY `fk_addon_option_updated_by` (`updated_by`),
  CONSTRAINT `fk_addon_option_created_by` FOREIGN KEY (`created_by`) REFERENCES `staff` (`staff_id`) ON DELETE SET NULL,
  CONSTRAINT `fk_addon_option_updated_by` FOREIGN KEY (`updated_by`) REFERENCES `staff` (`staff_id`) ON DELETE SET NULL,
...
--
-- Table structure for table `addon_option_audit`
--

DROP TABLE IF EXISTS `addon_option_audit`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `addon_option_audit` (
  `addon_option_audit_id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `addon_option_id` int unsigned NOT NULL,
  `action` enum('CREATE','UPDATE','ACTIVATE','DEACTIVATE','ASSIGN','UNASSIGN') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `changed_by` int unsigned DEFAULT NULL,
  `context_type` enum('CATALOG','MENU_ITEM') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'CATALOG',
  `context_id` int unsigned DEFAULT NULL,
  `change_summary` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  CONSTRAINT `fk_addon_audit_actor` FOREIGN KEY (`changed_by`) REFERENCES `staff` (`staff_id`) ON DELETE SET NULL,
  CONSTRAINT `fk_addon_audit_option` FOREIGN KEY (`addon_option_id`) REFERENCES `addon_option` (`addon_option_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `addon_option_audit`
--

LOCK TABLES `addon_option_audit` WRITE;
/*!40000 ALTER TABLE `addon_option_audit` DISABLE KEYS */;
/*!40000 ALTER TABLE `addon_option_audit` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `daily_stock` (`stock_id`, `menu_item_id`, `stock_date`, `opening_quantity`, `sold_quantity`, `adjusted_quantity`, `version`, `updated_by`, `last_updated`) VALUES (1,1,'2026-04-05',12,3,0,1,NULL,'2026-04-05 11:43:53'),(2,1,'2026-04-07',12,3,0,11,NULL,'2026-04-07 11:27:43'),(3,1,'2026-04-08',12,1,0,1,NULL,'2026-04-08 17:41:19'),(4,1,'2026-04-10',12,0,0,0,1,'2026-04-10 18:47:33'),(5,1,'2026-04-11',12,1,0,1,NULL,'2026-04-11 06:50:01'),(6,1,'2026-04-16',12,1,0,1,NULL,'2026-04-16 18:50:00'),(7,2,'2026-04-16',12,2,0,2,NULL,'2026-04-16 18:50:01'),(8,1,'2026-04-17',12,6,0,12,NULL,'2026-04-17 10:45:26'),(9,2,'2026-04-17',12,1,0,1,NULL,'2026-04-17 06:22:07'),(10,2,'2026-04-18',9,0,3,0,3,'2026-04-18 05:01:35'),(11,1,'2026-04-18',8,1,3,1,NULL,'2026-04-18 05:03:57'),(12,5,'2026-04-18',12,0,0,0,1,'2026-04-18 14:50:06'),(13,3,'2026-04-18',12,0,0,0,1,'2026-04-18 14:50:08'),(14,4,'2026-04-18',12,1,0,3,NULL,'2026-04-18 19:43:09'),(15,1,'2026-04-19',10,0,0,0,NULL,'2026-04-18 18:30:00'),(16,2,'2026-04-19',12,0,0,0,NULL,'2026-04-18 18:30:00'),(17,3,'2026-04-19',12,0,0,0,NULL,'2026-04-18 18:30:00'),(18,4,'2026-04-19',12,0,0,0,NULL,'2026-04-18 18:30:00'),(19,5,'2026-04-19',12,0,0,0,NULL,'2026-04-18 18:30:00');
...
INSERT INTO `menu_item` VALUES (1,'Chicken Burger','Juicy, perfectly seasoned chicken patty grilled to golden perfection, layered with crisp lettuce, fresh tomatoes, and creamy mayo, all tucked inside a soft toasted bun. A timeless favorite that never disappoints.',500.00,'https://res.cloudinary.com/dtfiyk6vx/image/upload/v1776327319/voleena/menu/shutterstock_574607542-1776327317958-9abccc66.jpg',1,1,1,1,'2026-04-05 11:30:24','2026-04-18 20:30:00'),(2,'Chicken Kottu','Chopped godamba roti stir-fried with chicken, vegetables, egg, and spices.',700.00,'https://res.cloudinary.com/dtfiyk6vx/image/upload/v1776327335/voleena/menu/slk1-1776327334768-d26c7a0d.webp',2,1,1,1,'2026-04-16 08:15:37','2026-04-18 20:30:00'),(3,'Seafood Fried Rice','Flavorful rice stir-fried with prawns, cuttlefish, vegetables, and soy sauce.',800.00,'https://res.cloudinary.com/dtfiyk6vx/image/upload/v1776520330/voleena/menu/buttery_seafood_fried_rice_recipe_tiffy_chen-1776230994252-c-1776520326957-4f06901c.jpg',3,1,1,1,'2026-04-18 13:52:10','2026-04-18 20:30:00'),(4,'Chicken Rice & Curry','Steamed rice served with spicy chicken curry, dhal, vegetable curry, and sambol.',450.00,'https://res.cloudinary.com/dtfiyk6vx/image/upload/v1776520367/voleena/menu/ricecurry-chicken-1776230654606-eba822a1-1776520364493-b5bd8fef.png',4,1,1,1,'2026-04-18 13:52:47','2026-04-18 20:30:00'),(5,'Fresh Lime Juice','Chilled lime juice with a hint of sugar and salt.',150.00,'https://res.cloudinary.com/dtfiyk6vx/image/upload/v1776520395/voleena/menu/lime-juice-fresh-1-1776231097016-e08f56b8-1776520392657-3a2979e1.png',5,1,1,1,'2026-04-18 13:53:19','2026-04-18 20:30:00');
...
CREATE TABLE `menu_item_addon_option` (
  ...
  KEY `idx_menu_item_addon_order` (`menu_item_id`,`display_order`,`addon_option_id`),
...
INSERT INTO `token_blacklist` VALUES (83,'b716710359362fc7bf227e53c4f8c095a133fe6e7431b09ac52beec2bf39aea0','STAFF',4,'2026-04-19 00:00:42','LOGOUT','2026-04-18 18:00:49'),(84,'26a0d97309a208cf080f552e81f9339470e3d6b1c56b58aeaccd638a7fff2b83','STAFF',1,'2026-04-19 00:00:53','LOGOUT','2026-04-18 18:00:56'),(85,'3c200366ead44a7d5a0495b646589f3df2f063ed3acdf1506ad2c98c1ee5ce55','STAFF',2,'2026-04-19 00:00:58','LOGOUT','2026-04-18 18:01:07'),(86,'863afe5395299fc14f6fdd55068342773e7695d61fded59a22ce3a517cf38ea0','STAFF',2,'2026-04-19 00:24:00','LOGOUT','2026-04-18 18:26:13'),(87,'31c74c889ed8807e23c92281e434f8842f832a0e56758d48f154ce50e23f2e14','CUSTOMER',2,'2026-04-19 00:26:16','LOGOUT','2026-04-18 18:37:08'),(88,'57820f729b050b66b2e29ec1850ecd65bdd6a63afd284d2fe9e4c285b7a4f648','CUSTOMER',2,'2026-04-19 00:39:14','LOGOUT','2026-04-18 19:06:29'),(89,'3034ad99674d67ebf3a640d93964468c7b69777df4f68ce49b5c875d28d52c0a','STAFF',1,'2026-04-19 01:06:32','LOGOUT','2026-04-18 19:13:31'),(90,'fae5b800335e9155359fc698a2911bbe7bc81e4b42bf16af3b55ff32773a57e7','CUSTOMER',2,'2026-04-19 01:13:34','LOGOUT','2026-04-18 19:29:45'),(91,'d6be2a0291f43a1401d6c496ac76b7b2897e025819ca47765064b19d458f34b8','STAFF',1,'2026-04-19 01:29:47','LOGOUT','2026-04-18 19:30:08'),(92,'76837d3b45457be5a279598d5e596000a1f4f97baad9247c8a2fa4c4facd37bf','STAFF',1,'2026-04-19 01:30:10','LOGOUT','2026-04-18 19:30:17'),(93,'bffb53af785088b847bc05336494d0011b0885badedf397828519ca231c02e60','CUSTOMER',2,'2026-04-19 01:30:19','LOGOUT','2026-04-18 19:32:42'),(94,'08b67d74c12235da2c6b16bed874304a338e718ef8dca8604d5ab733c50ba21a','STAFF',1,'2026-04-19 01:32:44','LOGOUT','2026-04-18 19:33:11'),(95,'c23779d86e132e8bb16a91b716fd71f365f000a962942627c0e9b0ef0234611c','STAFF',1,'2026-04-19 01:40:39','LOGOUT','2026-04-18 19:41:23'),(96,'ed8a31fdfe2f3333115a70eb083eeca49f7254f388602a625a2790d25e744e70','STAFF',2,'2026-04-19 01:41:25','LOGOUT','2026-04-18 19:42:00'),(97,'6c10e2403b915c72012d9928331c6993061a09525c1709e1bfcb13553b852f28','STAFF',3,'2026-04-19 01:42:03','LOGOUT','2026-04-18 19:42:06'),(98,'83d68b6c449d69bf0bf166328fc0131f9851ba8a87d651b23bbff590db97a9ca','STAFF',4,'2026-04-19 01:42:09','LOGOUT','2026-04-18 19:42:23'),(99,'d2b440db9a8da47f5f5335f49c01086728ffe97c7ac12911535720a288eeb7b7','CUSTOMER',2,'2026-04-19 02:13:48','LOGOUT','2026-04-18 20:25:00'),(100,'70832aab6026c97cfc4cf6c0babca31047aea0ea2cb9fd4384e9f65a4f8683cd','STAFF',1,'2026-04-19 02:25:04','LOGOUT','2026-04-18 20:28:08'),(101,'dde814141a30381e601b2b98d243e9c94183ac710d7296b56d1daad2d55735da','CUSTOMER',2,'2026-04-19 02:28:10','LOGOUT','2026-04-18 20:31:12');
...
--
-- Temporary view structure for view `vw_menu_item_addon_catalog`
--

DROP TABLE IF EXISTS `vw_menu_item_addon_catalog`;
/*!50001 DROP VIEW IF EXISTS `vw_menu_item_addon_catalog`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vw_menu_item_addon_catalog` AS SELECT 
 1 AS `menu_item_addon_option_id`,
 1 AS `menu_item_id`,
 1 AS `addon_option_id`,
 1 AS `code`,
 1 AS `name`,
 1 AS `description`,
 1 AS `addon_group`,
...
--
-- Final view structure for view `vw_menu_item_addon_catalog`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_menu_item_addon_catalog` AS select `miao`.`menu_item_addon_option_id` AS `menu_item_addon_option_id`,`miao`.`menu_item_id` AS `menu_item_id`,`miao`.`addon_option_id` AS `addon_option_id`,`ao`.`code` AS `code`,`ao`.`name` AS `name`,`ao`.`description` AS `description`,`ao`.`addon_group` AS `addon_group`,`ao`.`price_delta` AS `price_delta`,`ao`.`is_active` AS `is_active`,`miao`.`is_required` AS `is_required`,`miao`.`max_qty` AS `max_qty`,`miao`.`is_default` AS `is_default`,`miao`.`display_order` AS `display_order` from (`menu_item_addon_option` `miao` join `addon_option` `ao` on((`ao`.`addon_option_id` = `miao`.`addon_option_id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2026-04-19  2:13:52
